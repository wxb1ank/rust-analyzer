...
// - `preserve`: Do not change the granularity of any imports and preserve the original structure
//  written by the developer. For auto-import this has the same effect as `item`.
//
